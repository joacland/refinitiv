...
if __name__ == "__main__":
    ...
    OUT_FNAME = "ibes_eps_annual"  # Name of output file
    ...
    if __name__ == "__main__":
        ...
        for yr in range(FIRST_YEAR, LAST_YEAR + 1):
            ...
            # OUT FILE MGMT
            # File per year
            O_FNAME = f"{OUT_FNAME}_{str(yr)}{OUT_FNAME_SUFFIX}"
            ...
            print(f"SDate :{str(SDATE)}. Period: {period}")
            ...
            for line_start in range(0, len(own_list) + 1, SIZE):
                ...
                # Pause for 2s to reduce risk of throwing an exception (Not necessary
                # time.sleep(2)
    print("DONE")
